...
function activate(context) {
    let lastInput;
    let alignByRegex = vscode.commands.registerTextEditorCommand('aligner.align_by_regex', (textEditor, edit, args) => __awaiter(this, void 0, void 0, function* () {
        let input = "";
		if (args) {
			...
			input = yield vscode.window.showInputBox({prompt: 'Enter regular expression', value: lastInput });
		}
